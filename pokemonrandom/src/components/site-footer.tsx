      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="/#team" className="hover:text-foreground transition-colors">Team Builder</a></li>
              <li><a href="/#wheel" className="hover:text-foreground transition-colors">Type Wheel</a></li>
              <li><a href="/#guess" className="hover:text-foreground transition-colors">Guess Game</a></li>
              <li><a href="/#randomizer" className="hover:text-foreground transition-colors">Randomizer</a></li>
              <li><a href="/#compare" className="hover:text-foreground transition-colors">Compare</a></li>
              <li><a href="/#type-chart" className="hover:text-foreground transition-colors">Type Chart</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="/dmca" className="hover:text-foreground transition-colors">DMCA / Copyright</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-border/40 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <p>
            ...
            <a href="/disclaimer" className="underline hover:text-foreground">disclaimer</a>.
          </p>
