  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1" id="main-content" tabIndex={-1}>
        ...
        {/* Final push v2 */}
        <section className="mb-10 prose prose-lg dark:prose-invert max-w-none">
          <h2>Popular Tier List Categories</h2>
          <p>The Pokémon community creates tier lists for a wide variety of categories beyond just competitive viability. Some popular tier list categories include design rankings, where fans rank Pokémon based on their visual appearance and aesthetics. Nostalgia tier lists rank Pokémon based on how memorable or iconic they are, often favoring Generation 1 and 2 Pokémon that have been part of the franchise since its early days. Shiny tier lists rank Pokémon based on how appealing their shiny forms are, with some shiny forms being highly sought after for their dramatic color changes. Anime appearance tier lists rank Pokémon based on their roles and personalities in the animated series. Trading card tier lists rank Pokémon based on the value and rarity of their trading cards. Whatever your interest in Pokémon, you can create a tier list that reflects your personal rankings and share it with the community.</p>
          <p>Our tier list builder supports all of these categories and more. You can customize the tier names, colors, and number of tiers to suit your specific ranking criteria. You can also add notes and explanations for each tier to provide context for your rankings. Once you have completed your tier list, you can save it as an image and share it on social media, forums, or with friends. Tier lists are a fun and engaging way to express your opinions about Pokémon and to start discussions with other fans. Whether you are ranking Pokémon by competitive viability, design, or any other criteria, our tier list builder provides the tools you need to create professional-looking tier lists quickly and easily.</p>
        </section>
        </div>
      </main>
      <FooterAd />
