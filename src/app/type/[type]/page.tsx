  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1" id="main-content" tabIndex={-1}>
        ...
        {/* Final push v3 */}
        <section className="mb-10 prose prose-lg dark:prose-invert max-w-none">
          <h2>Pokémon of This Type in the National Pokédex</h2>
          <p>The National Pokédex contains a diverse selection of Pokémon of this type, spanning all nine generations of the franchise. From the original 151 Kanto Pokémon to the latest additions in Generation 9 Paldea, this type has been represented by creatures of all shapes, sizes, and power levels. Some of the most iconic Pokémon in the franchise belong to this type, including legendary and mythical Pokémon that are among the most powerful in the game. The Pokémon of this type have appeared in every main series game, the animated series, the trading card game, and merchandise, making them an integral part of the Pokémon brand.</p>
          <p>When browsing the Pokémon of this type in our Pokédex, you will find a wide range of base stats, abilities, and type combinations. Some Pokémon of this type are pure type, meaning they have only this type and no secondary type. Others are dual type, combining this type with another type to create unique strengths and weaknesses. The type combinations of this type Pokémon can significantly affect their competitive viability, as some combinations provide excellent defensive synergy while others create exploitable weaknesses. Use our Pokédex to explore the Pokémon of this type, filter by generation or stat range, and find the best Pokémon for your team.</p>
          <p>The Pokémon of this type have evolved over the course of the franchise, with new Pokémon being added in each generation. Some generations introduced many new Pokémon of this type, while others introduced only a few. The design of these Pokémon draws inspiration from real-world animals, mythological creatures, and cultural references, giving each one a unique personality and backstory. Some Pokémon of this type have received new forms, Mega Evolutions, or Gigantamax forms in later generations, giving them renewed relevance in the competitive scene. Whether you are a fan of the original Generation 1 Pokémon or prefer the newer designs from Generation 9, this type offers a rich selection of creatures to discover and use in your Pokémon journey.</p>
        </section>

        {/* Final push v4 */}
        <section className="mb-10 prose prose-lg dark:prose-invert max-w-none">
          <h2>Moves of This Type and Their Effects</h2>
          <p>The moves of this type offer a wide variety of effects, from simple damaging attacks to complex status moves that can change the course of a battle. Each move has its own power, accuracy, PP, and secondary effects that determine its strategic value. Some moves of this type are known for their high power and reliability, making them staples on competitive teams. Others have unique effects like stat changes, status conditions, or field effects that can provide strategic advantages beyond just dealing damage. Understanding the full range of moves available to this type is essential for maximizing its potential in battle.</p>
          <p>In competitive play, the most popular moves of this type are typically those that offer the best combination of power, accuracy, and secondary effects. Moves with 100 percent accuracy are highly valued for their reliability, as missing a crucial attack can cost you the battle. Moves with secondary effects like stat changes or status conditions can provide additional value beyond their raw damage output. Moves with unique effects like priority, recovery, or field manipulation can be game-changing in the right situation. When building a moveset for a Pokémon of this type, consider including at least one STAB move that takes advantage of the 50 percent damage bonus, plus coverage moves that can handle types that resist or are immune to this type. Our moves database provides detailed information about every move in the game, including type, category, power, accuracy, and effects.</p>
          <p>The moves of this type have evolved over the course of the franchise, with new moves being added in each generation and existing moves being adjusted for balance. Some moves have had their power or accuracy changed, while others have been removed entirely. The introduction of new mechanics like Z-Moves in Generation 7, Dynamax in Generation 8, and Terastallize in Generation 9 has also added new dimensions to how moves are used in battle. Z-Moves allow any move to be upgraded to a powerful single-use attack, while Max Moves and Tera Blast provide unique effects based on the move type or the user Tera type. Keeping up with these changes and understanding how they affect the moves of this type is important for competitive players who want to stay at the top of their game.</p>
        </section>
        </div>
      </main>
      <FooterAd />
